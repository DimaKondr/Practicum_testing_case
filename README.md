...
* После вызова **git log** появляется список коммитов с их описанием:
  ...
  <ol>
  <li>Строка из цифр и латинских букв после слова <strong>commit</strong> — это хеш коммита;</li>
  <li><strong>Author</strong> — имя автора и его электронная почта;</li>
  <li><strong>Date</strong> — дата и время создания коммита;</li>
